...
func GetFunctionResult(e *engine.Engine, functionName string, parameter []string) string {
	return executeFunction(get(e, functionName), parameter)
}

// 根据函数名称获取函数
func get(e *engine.Engine, funcName string) func([]string) string {
...
// 添加函数
func addFunc(e *engine.Engine, fun func([]string) string) {
